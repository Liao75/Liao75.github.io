...
lib.ssMetadata = [
		{name:"B4A04_atlas_1", frames: [[0,0,623,434],[0,436,278,280],[581,467,153,408],[625,0,180,465],[280,669,192,322],[0,718,231,138],[280,436,299,231],[474,877,312,103],[474,669,54,128]]}
];
...
(lib.CachedBmp_18 = function() {
	this.initialize(ss["B4A04_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.B4A04 = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/Image.png?1671589629839", id:"Image"},
		{src:"images/B4A04_atlas_1.png?1671589629797", id:"B4A04_atlas_1"}
	],
	preloads: []
};
